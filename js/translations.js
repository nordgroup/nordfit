...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const activeLanguage = getSavedLanguage();
  ...
  function getSavedLanguage() {
    try {
      const stored = localStorage.getItem("nordfit-language");
  ...
  function applyLanguage(lang) {
    ...
    updateLangLabel(safeLang);
    updateDocumentLanguage(safeLang);
    updateLanguageMenuLabels(safeLang);
    updateSelectedLanguageUI(safeLang);

    const pageTranslations = translations[pageKey] || {};
    const fallbackDictionary = pageTranslations[defaultLanguage] || {};
    const currentDictionary = pageTranslations[safeLang] || {};
    ...
    Object.entries(mergedDictionary).forEach(([selector, value]) => {
  ...
  function updateLanguageMenuLabels(lang) {
    const labels = languageMenuLabels[lang] || languageMenuLabels[defaultLanguage];
  ...
  function buildSharedSelectors(lang) {
    return {
      ".nav-link:nth-of-type(1)": { text: common.nav[lang][0] },
      ".nav-link:nth-of-type(2)": { text: common.nav[lang][1] },
      ".nav-link:nth-of-type(3)": { text: common.nav[lang][2] },
      ".nav-link:nth-of-type(4)": { text: common.nav[lang][3] },
      ".nav-link:nth-of-type(5)": { text: common.nav[lang][4] },
      ".nav-link:nth-of-type(6)": { text: common.nav[lang][5] },

      ".footer-links a:nth-child(1)": { text: common.footer[lang][0] },
      ".footer-links a:nth-child(2)": { text: common.footer[lang][1] },
      ".footer-links a:nth-child(3)": { text: common.footer[lang][2] },
      ".footer-links a:nth-child(4)": { text: common.footer[lang][3] },
    };
  }
  ...
  const translations = {
    index: {
      ...
      en: {
        ...buildSharedSelectors("en"),
        ".hero-title": { html: "A studio that feels modern. And stays calm." },
        ".hero-subtitle": { html: "NordFit is made for people who do not want just any gym, but a place that feels clear, premium and genuinely good to return to." },
